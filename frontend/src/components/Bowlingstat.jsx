...
const Bowlingstat = ({ playerName = "Player Name", teamName = "Team Name" }) => {
...
>
  REAL CRICKET WORLDCUP AUG 2025
        ...
        >
         BEST BOWLING SPELL IN TOURNAMENT
        </h1>
        ...
        <p className="absolute top-[445px] w-full text-center px-16 text-[16px] leading-7 text-yellow-100/85">
            Awarded as Best Bowling Stat of the Tournament for exceptional performance.        </p>
        {/* Citation */}
