...
const Playert = ({ playerName = "Player Name", teamName = "Team Name" }) => {
...
>
  REAL CRICKET WORLDCUP AUG 2025
        ...
        <p className="absolute top-[445px] w-full text-center px-16 text-[16px] leading-7 text-yellow-100/85">
            Awarded as Player of the Tournament for exceptional performance, leadership under pressure, and exemplary sportsmanship throughout the competition.
        </p>
        {/* Citation */}
